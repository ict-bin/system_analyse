...
class Orchestrator:
            ...
            for mod_name in final_modules:
                ...
                for attempt in range(self._max_iter(s_cfg)):
                    ...
                    self._emit(
                        ...
                        stage=3,
                        module=mod_name,
                        has_report=(mod_dir / "module_report.md").exists(),
                    )
    ...
    def _build_final_summary(self, workspace: str, modules: list[str]) -> str:
        ...
        lines.append(f"\n**总计 {len(modules)} 个模块**")
        return "\n".join(lines)
>>>>>>> 1419ac4 (feat: add stage completion detection, resume from history, and enhanced reporting)
