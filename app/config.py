...
from .models import (
    ...
    PromptOverrideItem,
    RoleConfig,
    SelfReflectionConfig,  # noqa: F401
    ServiceConfig,
    TaskConfig,
    WORKER_PROMPT_KEYS,
...
def build_task_config(svc: ServiceConfig, prompt: str, cwd: str = "") -> TaskConfig:
    ...
    cfg = TaskConfig(
        ...
        model_stuck_timeout=getattr(svc, "model_stuck_timeout", 1800.0),
        model_stuck_max_activations=getattr(svc, "model_stuck_max_activations", 5),
